...
def create_dataset(data_path, batch_size=64, repeat_num=1, training=True):
    """定义数据集"""
...
class EvalCallBack(Callback):
    ...
    def __init__(self, eval_function, eval_param_dict, interval=1, eval_start_epoch=1, save_best_ckpt=True,
                 ckpt_directory="./output/resnet50_lr0.01_opt-adam_bs64", besk_ckpt_name="best.ckpt", metrics_name="acc"):
...
opt = nn.Adam(params=net.trainable_params(), learning_rate=0.01, beta1=0.9, beta2=0.999)
loss = nn.SoftmaxCrossEntropyWithLogits(sparse=True, reduction='mean')
